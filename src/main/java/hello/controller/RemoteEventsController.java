...
import hello.value.weather.response.InvalidCountryCodeExeption;
...
public class RemoteEventsController {
	...
	public List <Event> fetchCountryEvents (@PathVariable String country) throws InvalidCountryCodeExeption{
		...
		if (url != null) {
			...
			throw new InvalidCountryCodeExeption();
		}
	}
